...
const VFlashcard = {
    name: 'v-flashcard',
    template: `
        <div class="container" :style="{color:" style="margin-bottom: 20px;">
            <span>value.front.label</span>
            <span>value.front.value</span>
        </div>
    `,
    props: [
        '{color:',
...
const VMain = {
    ...
    template: `
        <div class="v-main">
            <h1>Trig Tips</h1>
            <div class="question">Is there a trick you use when solving difficult trig proofs?</div>
            <div class="answer">No not really.</div>
            <div class="question">What goes in your head when going about these situations?</div>
